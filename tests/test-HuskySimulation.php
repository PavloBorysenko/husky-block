 ...
 * Test_Husky_Simulation.
 */
class Test_Husky_Simulation extends WP_UnitTestCase {
	public function test_shortcode_name() {
		$shortcode_front = new \Husky\Block\Render\Shortcodes\HuskySimulation( array() );
		...
		$this->assertSame( 'woof_simulation', $shortcode_name );
	}
